...
<head>
    ...
    <style>
        ...
        .box { background: #28a745; color: white; padding: 20px; border-radius: 10px; width: 400px; margin: auto; text-align: center; }
        a { color: white; text-decoration: underline; display: block; margin-top: 20px; }
    </style>
</head>
<body>
    <div class="box">
        <h2>Welcome Editor, <?= $_SESSION['name'] ?>!</h2>
        <p>You can edit records.</p>
